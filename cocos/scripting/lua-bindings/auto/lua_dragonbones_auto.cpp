...
int lua_dragonbones_Slot_setDisplay(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 4,&arg2, "db.Slot:setDisplay");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_dragonbones_Slot_setDisplay'", nullptr);
            return 0;
...
int lua_dragonbones_DBCCArmatureNode_initWithDBCCArmature(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_dragonbones_DBCCArmatureNode_initWithDBCCArmature'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "db.DBCCArmatureNode:initWithDBCCArmature",argc, 2);
    return 0;
