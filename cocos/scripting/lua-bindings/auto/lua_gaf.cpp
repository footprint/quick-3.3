...
// +++footprint+++
int lua_gaf_GAFAsset_getFrameSize(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFAsset* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFAsset_getFrameSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFAsset_getFrameSize'", nullptr);
            return 0;
        }
        const gaf::GAFHeader& ret = cobj->getHeader();
        rect_to_luaval(tolua_S, ret.frameSize);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFAsset:getFrameSize",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFAsset_getFrameSize'.",&tolua_err);
#endif
...
int lua_register_gaf_GAFAsset(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GAFAsset");
        ...
        tolua_function(tolua_S,"getFrameSize", lua_gaf_GAFAsset_getFrameSize); //footprint+++
    tolua_endmodule(tolua_S);
...
// +++footprint
int lua_gaf_GAFObject_registerScriptHandler(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFObject_registerScriptHandler'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_registerScriptHandler'", nullptr);
            return 0;
        }
        cobj->registerScriptHandler(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFObject:registerScriptHandler",argc, 1);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFObject_registerScriptHandler'.",&tolua_err);
#endif
...
// +++footprint
int lua_gaf_GAFObject_unregisterScriptHandler(lua_State* tolua_S)
{
    int argc = 0;
    gaf::GAFObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_gaf_GAFObject_unregisterScriptHandler'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_gaf_GAFObject_unregisterScriptHandler'", nullptr);
            return 0;
        }
        cobj->unregisterScriptHandler();
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "gaf.GAFObject:unregisterScriptHandler",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_gaf_GAFObject_unregisterScriptHandler'.",&tolua_err);
#endif
...
int lua_register_gaf_GAFObject(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GAFObject");
        ...
        tolua_function(tolua_S,"registerScriptHandler",lua_gaf_GAFObject_registerScriptHandler); // +++footprint
        tolua_function(tolua_S,"unregisterScriptHandler",lua_gaf_GAFObject_unregisterScriptHandler); // +++footprint
