...
int lua_cocos2dx_extension_ControlHuePicker_setEnabled(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlHuePicker_setEnabled'", nullptr);
            return 0;
        }
        cobj->setEnabled(arg0);
        return 0;
...
int lua_cocos2dx_extension_ControlSaturationBrightnessPicker_setEnabled(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlSaturationBrightnessPicker_setEnabled'", nullptr);
            return 0;
        }
        cobj->setEnabled(arg0);
        return 0;
...
int lua_cocos2dx_extension_ControlColourPicker_setEnabled(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlColourPicker_setEnabled'", nullptr);
            return 0;
        }
        cobj->setEnabled(arg0);
        return 0;
...
int lua_cocos2dx_extension_ControlColourPicker_setColor(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlColourPicker_setColor'", nullptr);
            return 0;
        }
        cobj->setColor(arg0);
        return 0;
...
int lua_cocos2dx_extension_ControlColourPicker_init(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlColourPicker_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init();
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_cocos2dx_extension_ControlSlider_setEnabled(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlSlider_setEnabled'", nullptr);
            return 0;
        }
        cobj->setEnabled(arg0);
        return 0;
...
int lua_cocos2dx_extension_ControlSlider_needsLayout(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlSlider_needsLayout'", nullptr);
            return 0;
        }
        cobj->needsLayout();
        return 0;
...
int lua_cocos2dx_extension_ControlSlider_isTouchInside(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlSlider_isTouchInside'", nullptr);
            return 0;
        }
        bool ret = cobj->isTouchInside(arg0);
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_cocos2dx_extension_ControlStepper_update(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlStepper_update'", nullptr);
            return 0;
        }
        cobj->update(arg0);
        return 0;
...
int lua_cocos2dx_extension_ControlSwitch_setEnabled(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_ControlSwitch_setEnabled'", nullptr);
            return 0;
        }
        cobj->setEnabled(arg0);
        return 0;
...
int lua_cocos2dx_extension_TableViewCell_setReuseIdentifier(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::TableViewCell* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_TableViewCell_setReuseIdentifier'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "cc.TableViewCell:setReuseIdentifier");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_TableViewCell_setReuseIdentifier'", nullptr);
            return 0;
        }
        cobj->setReuseIdentifier(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableViewCell:setReuseIdentifier",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_TableViewCell_setReuseIdentifier'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_extension_TableViewCell_getReuseIdentifier(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::TableViewCell* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_TableViewCell_getReuseIdentifier'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_TableViewCell_getReuseIdentifier'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableViewCell:getReuseIdentifier",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_TableViewCell_getReuseIdentifier'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_extension_TableViewCell(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"TableViewCell");
        ...
        tolua_function(tolua_S,"setReuseIdentifier",lua_cocos2dx_extension_TableViewCell_setReuseIdentifier);
        tolua_function(tolua_S,"getReuseIdentifier",lua_cocos2dx_extension_TableViewCell_getReuseIdentifier);
...
int lua_cocos2dx_extension_TableView_scrollToIndex(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::TableView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_TableView_scrollToIndex'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_ssize(tolua_S, 2, &arg0, "cc.TableView:scrollToIndex");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_TableView_scrollToIndex'", nullptr);
            return 0;
        }
        cobj->scrollToIndex(arg0);
        return 0;
    }
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "cc.TableView:scrollToIndex");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_TableView_scrollToIndex'", nullptr);
            return 0;
        }
        cobj->scrollToIndex(arg0, arg1);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableView:scrollToIndex",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_TableView_scrollToIndex'.",&tolua_err);
#endif
...
int lua_cocos2dx_extension_TableView_dequeueCell(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            std::string arg0;
            ok &= luaval_to_std_string(tolua_S, 2,&arg0, "cc.TableView:dequeueCell");

            if (!ok) { break; }
            cocos2d::extension::TableViewCell* ret = cobj->dequeueCell(arg0);
            object_to_luaval<cocos2d::extension::TableViewCell>(tolua_S, "cc.TableViewCell",(cocos2d::extension::TableViewCell*)ret);
            return 1;
        }
    }while(0);
...
int lua_register_cocos2dx_extension_TableView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"TableView");
        ...
        tolua_function(tolua_S,"scrollToIndex",lua_cocos2dx_extension_TableView_scrollToIndex);
